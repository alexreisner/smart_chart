...
<b>SmartChart is still in the early stages of development. Only maps, barcodes, and line charts are working. However, much of the interface is described below (plus to-do list) and if you'd like to contribute, please do.</b>
...
* bar graphs
  * get examples/bar_chart_sparkline.rb to work
  * bar width, spacing
  * bar colors
